...
import com.pointlion.mvc.admin.oa.workflow.flowimg.img.CustomProcessDiagramGenerator;
...
public class FlowImgService {
    private static final Log LOG = Log.getLog(FlowImgService.class);
    public static FlowImgService me = new FlowImgService();
    private ProcessEngine processEngine = FlowablePlugin.buildProcessEngine();
